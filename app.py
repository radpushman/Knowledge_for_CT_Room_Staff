...
if mode == "💬 질문하기":
    ...
    # Gemini API 상태 표시
    if use_gemini:
        st.success("🤖 Gemini 2.0 Flash AI 답변 활성화됨")
    else:
...
"""
                    ...
                    st.success("✨ Gemini 2.0 Flash가 검색된 자료를 분석하여 답변을 재구성했습니다.")
                ...
                with st.expander("🤖 AI 답변 기능 활성화하기"):
                    st.markdown("""
                    **Gemini 2.0 Flash AI 답변 기능을 사용하려면:**
...
- **🤖 AI 질의응답**: Gemini 2.0 Flash로 스마트한 답변 생성 (일일 1,500회 무료)
